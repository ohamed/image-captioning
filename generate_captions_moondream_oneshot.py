...
BASE_PROMPT = (
    "You are an expert technical documenter. The following example demonstrates the "
    "exact concise, lowercase, noun-heavy language style required for engineering logs:"
    "'steel plate with two solid pins, four holes and threaded holes'"
    "Analyze the following target image and write a matching one-sentence technical caption. "
)
...
def main():
    ...
    if args.output:
        ...
        output_path = str(p.with_name(p.stem + "_oneshot" + p.suffix))
